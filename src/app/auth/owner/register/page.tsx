      ...
      <div className="w-full max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 border border-gray-100">
          ...
          >
            {isLoading ? (
              <>
                ...
                <span>Creating business account with Google...</span>
              </>
            ) : (
              <>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading || !fullName || !businessName || !email || !password || !agreeToTerms}
            ...
            >
              ...
              ) : !fullName || !businessName || !email || !password || !agreeToTerms ? (
                <span className="text-gray-300">Please fill in all fields and accept terms</span>
              ) : (
                <>
                  <span className="relative z-10">Create Business Account</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 opacity-0 hover:opacity-100 transition-opacity duration-300 -z-10"></div>
                </>
              )}
            </button>
          </form>
